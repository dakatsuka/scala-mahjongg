...
object Pai {
  ...
  def getPaiFamily(pai: Pai): PaiFamily = pai match {
    case M1 | M2 | M3 | M4 | M5 | M6 | M7 | M8 | M9 => Manz
    case P1 | P2 | P3 | P4 | P5 | P6 | P7 | P8 | P9 => Pinz
    case S1 | S2 | S3 | S4 | S5 | S6 | S7 | S8 | S9 => Souz
    case Ton | Nan | Sha | Pei                      => Kazehai
    case Haku | Hatsu | Chun                        => Sangenpai
  }
